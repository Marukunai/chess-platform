...
public class MatchmakingQueue {
    ...
    public record WaitingPlayer(String playerId, String username, String avatarUrl, int rating,
                                TimeControl timeControl, Instant queuedAt) {
    ...
    public void enqueue(String playerId, String username, String avatarUrl, int rating, TimeControl timeControl) {
        remove(playerId); // evita duplicados si ya estaba esperando (p. ej. doble click)
        queue.add(new WaitingPlayer(playerId, username, avatarUrl, rating, timeControl, Instant.now(clock)));
    }
